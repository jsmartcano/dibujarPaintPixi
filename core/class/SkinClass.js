...
(function (nameSpace) {
  nameSpace.SkinClass = function (_self) {
    ...
    var tintColours = [
      0xf8ff4b, 0xd48746, 0x8eae602, 0xffffff, 0xc03866, 0x5e77bb, 0x000000,
    ];
    ...
    this.loadTextures = function () {
      ...
      loader.onComplete.add((loader, resource) => {
        ...
        _self.InputManager.fireEvent.apply(_self.InputManager, [
          "onImagesLoaded",
        ]);
      });
    };
    ...
    this.refreshScreen = function () {
      ...
      switch (gameState.sizeIndex) {
        case 1:
          $("#grosor").addClass("grosor_1");
          break;
        case 2:
          $("#grosor").addClass("grosor_2");
          break;
        case 3:
          $("#grosor").addClass("grosor_3");
          break;
        case 4:
          $("#grosor").addClass("grosor_4");
          break;
      }
    ...
    // -----------------------------------------------------------------------
    $("#canvas_lines").on("touchcancel"),
      function (e) {
        e.preventDefault();
        self.endTools(e);
      };
    $("#canvas").on("touchcancel"),
      function (e) {
        e.preventDefault();
        self.endTools(e);
      };
    ...
    $("#canvas_images").bind("click mousedown touchend", function (e) {
      var x = self.getRealX(e);
      var y = self.getRealY(e);

      if (x >= tl.x - 100 && x <= tr.x + CORNER_WIDTH + 100 && 
          y >= tl.y - 100 && y <= br.y +  CORNER_HEIGHT + 100)
        {
        } else{ 
    ...
    this.getX = function (e) {
      ...
      try {
        if (e.originalEvent.changedTouches) {
          return e.originalEvent.changedTouches[0].offsetX;
        }
      } catch (ee) {}
    };
    ...
    this.getY = function (e) {
      ...
      try {
        if (e.originalEvent.changedTouches) {
          return e.originalEvent.changedTouches[0].offsetY;
        }
      } catch (ee) {}
    };
    ...
    this.setVariable = function (variable, value) {
      ...
      try {
        ...
        _self.DebugManager.say(
          "No se ha podido hacer set de " + varId + " a " + value
        );
      }
    };
    ...
    this.onDragTLStart = function (e) {
      draggin_tl = true;
    };
    this.onDragTLEnd = function (e) {
      draggin_tl = false;
    };

    this.onDragTRStart = function (e) {
      draggin_tr = true;
    };
    this.onDragTREnd = function (e) {
      draggin_tr = false;
    };

    this.onDragBRStart = function (e) {
      draggin_br = true;
    };
    this.onDragBREnd = function (e) {
      draggin_br = false;
    };

    this.onDragBLStart = function (e) {
      draggin_bl = true;
    };
    this.onDragBLEnd = function (e) {
      draggin_bl = false;
    };

    this.onDragMVStart = function (e) {
      draggin_mv = true;
    };
    this.onDragMVEnd = function (e) {
      draggin_mv = false;
    };
